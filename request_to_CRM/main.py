...
_ACCOUNT_ID = '2bad39338e4c'
_USER_ID = 'aee08abccfb1'
_ACCESS_TOKEN = 'e006730fb17a3764d8193df5d7a36d73'
...
def send_data_to_api():
    ...
    for client in data_pack:
        ...
        # #         'POST',
        # #         f'https://klientiks.ru/clientix/Restapi/add/a/{_ACCOUNT_ID}/u/{_USER_ID}/t/{_ACCESS_TOKEN}/m/Clients/',
        # #         fields=fields,
        # #     )
        #
